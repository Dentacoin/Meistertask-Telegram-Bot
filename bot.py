...
request_all_active_projects = json.loads(requests.get("https://www.meistertask.com/api/projects?status=all",headers=headers).text)
...
def send_message(text, chat_id):
    ...
    url = URL + "sendMessage?text={}&chat_id={}&parse_mode={}&disable_web_page_preview={}".format(text, chat_id, "HTML", "True")
    get_url(url)
